...
public class CandidateRequestProcessorTest {
    ...
    public void setup() {
        ...
        Mockito.when(driverStateMock.getCurrentState()).thenReturn(DriverState.State.CANDIDATE);
    ...
    public void testProcessUpdatesRequests() throws JsonProcessingException {
        ...
        DriverUpdateInfo updates = new DriverUpdateInfo(1, DriverState.State.CANDIDATE,
    ...
    public void testProcessMasterElectionRequest() {
        ...
        Mockito.verify(driverStateMock).setCurrentState(DriverState.State.CANDIDATE);
    }
