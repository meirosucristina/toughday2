...
public class SlaveRequestProcessorTest {
    ...
    public void testProcessUpdatesRequests() throws JsonProcessingException {
        ...
        DriverUpdateInfo updates = new DriverUpdateInfo(1, DriverState.State.SLAVE,
    ...
    public void testProcessMasterElectionRequest() {
        ...
        // test that driver-1 is running as slave after this process
        Mockito.verify(driverStateMock).setCurrentState(DriverState.State.SLAVE);
    }
    ...
    public void processExecutionRequest() throws Exception {
        ...
        // test that the sample content package should not be installed by the slaves
